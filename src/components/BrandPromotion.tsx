            ...
            <div className="lg:flex items-center justify-around h-full">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="hidden lg:flex items-center _bg-shade-2 p-3 mt-6 gap-3 rounded-xl">
                  ...
                  <div className="flex flex-col justify-center">
                    <p className="font-extrabold text-lg max-w-[300px] _text-default text-slate-50">
                      Simple way to download the Kuch Khalo app
                    </p>
                    <span className="text-sm _text-default text-slate-50">
                ...
                <div className="block lg:hidden mt-6">
                  <h4 className="font-semibold text-md leading-none mb-4">
                    Download the Kuch Khalo App Now
                  </h4>
